                    ...
                    <div className="flex items-center justify-center w-full lg:p-12">
                        <div className="flex items-center xl:p-10">
                            <form className="flex flex-col w-full h-full pb-6 text-center bg-transparent rounded-3xl">
                                ...
                                {formError && (
                                    <>
                                        <DefaultModal boolean={true} errorMessage={formError} />
                                    </>
                                )}
                                {passwordError && (
                                    <>
                                        <DefaultModal boolean={true} errorMessage={passwordError} />
                                    </>
                                )}
                                {responseMessage && !responseMessage.toString().includes('201') && (
                                    <>
                                        <DefaultModal boolean={true} errorMessage="Email already exists" />
                                    </>
                                )}
                                <button
